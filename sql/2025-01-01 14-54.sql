...
VALUES (1, 'admin', '127.0.0.1', '', 'Firefox', 'Linux', 1, '登录成功', '2024-09-23 15:31:37', 0),
       ...
       (124, 'sleepyhead@outlook.com', '192.168.3.189', '', 'Firefox', 'Linux', 1, '登录成功',
        '2024-12-31 09:05:36', 0),
       (125, 'sleepyhead@outlook.com', '192.168.3.189', '', 'Firefox', 'Linux', 1, '登录成功',
        '2024-12-31 09:53:49', 0),
       (126, 'sleepyhead@outlook.com', '192.168.3.189', '', 'Firefox', 'Linux', 1, '登录成功',
        '2024-12-31 12:16:30', 0),
       (127, 'sleepyhead@outlook.com', '192.168.3.189', '', 'Firefox', 'Linux', 1, '登录成功',
        '2024-12-31 15:02:37', 0),
       (128, 'sleepyhead@outlook.com', '192.168.3.189', '', 'Firefox', 'Linux', 1, '登录成功',
        '2024-12-31 17:26:42', 0),
       (129, 'sleepyhead@outlook.com', '192.168.3.189', '', 'Firefox', 'Linux', 1, '登录成功',
        '2025-01-01 09:38:51', 0),
       (130, 'sleepyhead@outlook.com', '192.168.3.189', '', 'Firefox', 'Linux', 1, '登录成功',
        '2025-01-01 10:12:22', 0),
       (131, 'sleepyhead@outlook.com', '192.168.3.189', '', 'Firefox', 'Linux', 1, '登录成功',
        '2025-01-01 11:28:40', 0),
       (132, 'sleepyhead@outlook.com', '192.168.3.189', '', 'Firefox', 'Linux', 1, '登录成功',
        '2025-01-01 14:11:19', 0);
...
VALUES (2, 0, 'Dashboard', 2, 'BasicLayout', '/', NULL,
       ...
       (9, 0, 'SystemManage', 2, 'BasicLayout', '/system/menu', '/system/menu/index',
        ...
        NULL, '系统管理', 4, '2024-12-30 14:05:48', 4, '2025-01-01 14:28:57', 0, 1),
       (10, 9, 'MenuManage', 1, '/system/menu/index', '/system/menu/index', NULL,
        ...
        NULL, '菜单管理', 4, '2024-12-30 14:06:32', 4, '2025-01-01 14:29:06', 0, 1),
       ...
       (13, 9, 'DeptManage', 1, '/system/dept/index', '/system/dept/index', NULL,
        '{\"affixTab\":false,\"affixTabOrder\":0,\"hideChildrenInMenu\":false,\"hideInBreadcrumb\":false,\"hideInMenu\":false,\"hideInTab\":false,\"icon\":\"fluent:organization-20-filled\",\"ignoreAccess\":false,\"title\":\"system.dept.title\"}',
        NULL, '部门管理', 4, '2025-01-01 14:29:47', 4, '2025-01-01 14:35:44', 0, 1),
       (14, 0, 'VbenProject', 2, 'BasicLayout', '/vben-admin', NULL,
        '{\"affixTab\":false,\"affixTabOrder\":0,\"hideChildrenInMenu\":false,\"hideInBreadcrumb\":false,\"hideInMenu\":false,\"hideInTab\":false,\"icon\":\"\",\"ignoreAccess\":false,\"order\":9999,\"title\":\"demos.vben.title\"}',
        NULL, '项目', 4, '2025-01-01 14:44:20', 4, '2025-01-01 14:47:11', 0, 1),
       (15, 14, 'VbenDocument', 3, 'IFrameView', '/vben-admin/document', NULL,
        '{\"affixTab\":false,\"affixTabOrder\":0,\"hideChildrenInMenu\":false,\"hideInBreadcrumb\":false,\"hideInMenu\":false,\"hideInTab\":false,\"iframeSrc\":\"https://doc.vben.pro\",\"ignoreAccess\":false,\"title\":\"demos.vben.document\"}',
        NULL, '文档', 4, '2025-01-01 14:45:47', 4, '2025-01-01 14:46:23', 0, 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (1, 1, 2, '用户管理', '/system/users',
       ...
       (46, 2, 3, '菜单管理', '/system/menus/9',
        'com.springboottemplate.admin.controller.system.SysMenuController.edit()', 1, 0,
        'sleepyhead@outlook.com', '192.168.3.189', '', 0, NULL, '{menuId=9}', '', 1, '',
        '2025-01-01 14:28:57', 0),
       (47, 2, 3, '菜单管理', '/system/menus/10',
        'com.springboottemplate.admin.controller.system.SysMenuController.edit()', 1, 0,
        'sleepyhead@outlook.com', '192.168.3.189', '', 0, NULL, '{menuId=10}', '', 1, '',
        '2025-01-01 14:29:07', 0),
       (48, 1, 2, '菜单管理', '/system/menus',
        'com.springboottemplate.admin.controller.system.SysMenuController.add()', 1, 0,
        'sleepyhead@outlook.com', '192.168.3.189', '', 0, NULL,
        '{\"parentId\":9,\"menuName\":\"DeptManage\",\"menuType\":1,\"component\":\"/system/dept/index\",\"path\":\"/system/dept/index\",\"meta\":{\"affixTab\":false,\"affixTabOrder\":0,\"hideChildrenInMenu\":false,\"hideInBreadcrumb\":false,\"hideInMenu\":false,\"hideInTab\":false,\"ignoreAccess\":false,\"title\":\"system.dept.title\"},\"remark\":\"部门管理\",\"status\":true},',
        '', 1, '', '2025-01-01 14:29:47', 0),
       (49, 2, 3, '菜单管理', '/system/menus/13',
        'com.springboottemplate.admin.controller.system.SysMenuController.edit()', 1, 0,
        'sleepyhead@outlook.com', '192.168.3.189', '', 0, NULL, '{menuId=13}', '', 1, '',
        '2025-01-01 14:35:44', 0),
       (50, 1, 2, '菜单管理', '/system/menus',
        'com.springboottemplate.admin.controller.system.SysMenuController.add()', 1, 0,
        'sleepyhead@outlook.com', '192.168.3.189', '', 0, NULL,
        '{\"menuName\":\"VbenProject\",\"menuType\":2,\"component\":\"BasicLayout\",\"path\":\"/vben-admin\",\"meta\":{\"affixTab\":false,\"affixTabOrder\":0,\"hideChildrenInMenu\":false,\"hideInBreadcrumb\":false,\"hideInMenu\":false,\"hideInTab\":false,\"icon\":\"\",\"ignoreAccess\":false,\"title\":\"demos.vben.title\"},\"remark\":\"项目\",\"status\":true},',
        '', 1, '', '2025-01-01 14:44:20', 0),
       (51, 1, 2, '菜单管理', '/system/menus',
        'com.springboottemplate.admin.controller.system.SysMenuController.add()', 1, 0,
        'sleepyhead@outlook.com', '192.168.3.189', '', 0, NULL,
        '{\"parentId\":14,\"menuName\":\"VbenDocument\",\"menuType\":3,\"component\":\"IFrameView\",\"path\":\"/vben-admin/document\",\"meta\":{\"affixTab\":false,\"affixTabOrder\":0,\"hideChildrenInMenu\":false,\"hideInBreadcrumb\":false,\"hideInMenu\":false,\"hideInTab\":false,\"iframeSrc\":\"https://doc.vben.pro\",\"ignoreAccess\":false,\"title\":\"demos.vben.document\"},\"remark\":\"文档\",\"status\":true},',
        '', 1, '', '2025-01-01 14:45:47', 0),
       (52, 2, 3, '菜单管理', '/system/menus/15',
        'com.springboottemplate.admin.controller.system.SysMenuController.edit()', 1, 0,
        'sleepyhead@outlook.com', '192.168.3.189', '', 0, NULL, '{menuId=15}', '', 1, '',
        '2025-01-01 14:46:23', 0),
       (53, 2, 3, '菜单管理', '/system/menus/14',
        'com.springboottemplate.admin.controller.system.SysMenuController.edit()', 1, 0,
        'sleepyhead@outlook.com', '192.168.3.189', '', 0, NULL, '{menuId=14}', '', 1, '',
        '2025-01-01 14:47:11', 0);
...
VALUES (1, 1, 1, 1, 'admin', 'superadmin', 0, '', '123456', 0, '',
       ...
       (4, 1, 1, 1, 'sleepyhead@outlook.com', 'sleepyhead', 0, 'sleepyhead@outlook.com', '13213', 0,
        ...
        '2025-01-01 14:11:19', 1, 1, '2024-09-24 09:21:20', 4, '2025-01-01 14:11:19', '', 0);
...
-- Dump completed on 2025-01-01 14:54:03
