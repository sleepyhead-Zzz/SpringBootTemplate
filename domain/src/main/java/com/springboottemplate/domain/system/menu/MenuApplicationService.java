package com.springboottemplate.domain.system.menu;
...
import com.springboottemplate.domain.system.menu.model.MenuModel;
import com.springboottemplate.domain.system.menu.model.MenuModelFactory;
...
public class MenuApplicationService {
    ...
    public List<Tree<Long>> buildMenuTreeSelect(List<SysMenuEntity> menus) {
        ...
        return TreeUtil.build(menus, 0L, config, (menu, tree) -> {
            ...
            tree.putExtra("label", menu.getRemark());
        });
    }
