...
/**
 * 路由显示信息 必须加上@JsonInclude(Include.NON_NULL)的注解  否则传null值给Vue动态路由渲染时会出错
 *
 * @author valarchie
 */
@Data
...
public class MetaDTO {
    ...
    /**
     * 是否是内部页面   使用frameSrc来嵌入页面时，当isFrameSrcInternal=true的时候, 前端需要做特殊处理 比如链接是 /druid/login.html 前端需要处理成
